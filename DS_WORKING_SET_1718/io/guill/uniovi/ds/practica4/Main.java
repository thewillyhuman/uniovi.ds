...
public class Main {
	...
	public static void main(String[] args) {
		...
		form.addField(new Field("Ciudad",
				new OptionsValidator("Santander", "Oviedo", "Cádiz")));

		form.addField(new Field("Código Producto", new LenghtValidator(4)));
		form.addField(new Field("Código Postal", new LenghtValidator(4),
				new DigitValidator()));
		form.addField(new Field("Edad", new DigitValidator(),
				new NumberGreaterThanValidator(18)));
		form.addField(new Field("Sueldo", new DigitValidator(),
				new NumberGreaterThanValidator(800),
				new NumberLowerThanValidator(1200)));
		form.addField(new Field("Ubicación",
				new OptionsValidator("Oviedo", "Santander", "Cádiz"),
				new LenghtValidator(4)));
